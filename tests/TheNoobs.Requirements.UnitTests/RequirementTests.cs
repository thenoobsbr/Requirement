...
public class RequirementTests
{
    ...
    public void BeInRange_ShouldNotThrowException_WhenValueIsInRange<T>(T value, T minValue, T maxValue)
    ...
    public void BeInRange_ShouldThrowException_WhenValueIsNotInRange<T>(T value, T minValue, T maxValue)
        where T : IComparable<T>
    {
        // Arrange
        var requirement = Requirement.To();
    ...
    public void HaveMaxLength_ShouldNotThrowException_WhenTextLengthIsLessThanOrEqualToMaxLength(string text,
        int maxLength)
    {
        // Arrange
        var requirement = Requirement.To();
